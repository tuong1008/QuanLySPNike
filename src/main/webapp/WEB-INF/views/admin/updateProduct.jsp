    ...
    <div class="container">
	   ...
	   <div class="page-header title">
		...
		<div class="form-layout">
	       <form:form   action="${pageContext.request.contextPath}/admin/product/updateProduct.htm"   method="post" modelAttribute="product"    enctype="multipart/form-data" class="form-horizontal"  >
