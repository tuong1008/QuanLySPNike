    ...
    <div class="container">
	   ...
	   <div class="page-header title">
		...
		<div class="form-layout">
	       <form:form   action="${pageContext.request.contextPath}/admin/product/addProduct.htm" enctype="multipart/form-data"  method="post" modelAttribute="product" class="form-horizontal"  >
