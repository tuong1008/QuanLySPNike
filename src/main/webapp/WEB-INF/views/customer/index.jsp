        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value='/product/productList/Laptop/1'/>"
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value='/product/productList/Mobile/1'/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value='/product/productList/Camera/1'/>"
                          role="button">View Product List</a></p>
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/tv.jpg"/>"
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Tv/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/refrigerator.jpg"/>"
                             alt="Generic placeholder image" width="140" height="140">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Refrigerator/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/tablet.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Tablet/1"/>"
                          role="button">View Product List</a></p>
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/micro%20oven.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/MicroOven/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/dvd.jpg"/>"
                             alt="Generic placeholder image" width="140" height="140">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/DvdPlayer/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/fan.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Fan/1"/>"
                          role="button">View Product List</a></p>
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/printer.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Printer/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/desktop.jpg"/>"
                             alt="Generic placeholder image" width="140" height="140">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Desktop/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/washing%20machines.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Washing Machine/1"/>"
                          role="button">View Product List</a></p>
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/ipad.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    <h2>iPad</h2>
                    <p>Get latest iPad </p>
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/ipad/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/game%20consol.jpg"/>"
                             alt="Generic placeholder image" width="140" height="140">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Game console/1"/>"
                          role="button">View Product List</a></p>
        ...
        <div class="col-lg-4">
            ...
            <div class="product-single">
                <div class=" text-center productColumn">
                    <div class=" img-responsive productImage">
                        <img class="img-circle" src="<c:url value="/resources/images/router.jpg"/>"
                             alt="Generic placeholder image" width="190" height="190">
                ...
                <div class="product-desc">
                    ...
                    <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Router/1"/>"
                          role="button">View Product List</a></p>
