                ...
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body p-5">
                        ...
                        <form:form action="${pageContext.request.contextPath}/register.htm" method="post" modelAttribute="customer"
                            ...
                            <div class="form-group has-success">
                                <div class="col-xs-9">
                                    <form:input path="billingAddress.city" class="form-control"
                                                placeholder="Street Name" id="billingAddress.city"/>
                                </div>
                            </div>
                            <div class="form-outline mb-0">
                                <label class="col-xs-3 control-label" for="customerName"></label>
                            ...
                            <div class="form-group has-success">
                                <div class="col-xs-9">
                                    <form:input path="billingAddress.country" class="form-control"
                                                placeholder="Apartment Number" id="billingAddress.country"/>
                                </div>
                            </div>
                            <div class="form-outline mb-0">
                                <label class="col-xs-3 control-label" for="customerName"></label>
                            ...
                            <div class="form-group has-success">
                                <div class="col-xs-9">
                                    <form:input path="billingAddress.zipCode" class="form-control" placeholder="City"
                            ...
                            <div class="form-group has-success">
                                <div class="col-xs-9">
                                    <form:input path="shippingAddress.address" class="form-control"
                                                placeholder="Street Name" id="shippingAddress.address"/>
                                </div>
                            </div>
                            <div class="form-outline mb-0">
                                <label class="col-xs-3 control-label" for="customerName"></label>
                            ...
                            <p class="text-center text-muted mt-3 mb-0">Already have an account? <a href="login.htm" class="fw-bold text-body"><u>Login</u></a></p>
                        </form:form>
                    </div>
                </div>
            </div>
