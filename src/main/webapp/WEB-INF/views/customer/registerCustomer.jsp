        ...
        <div class="form-layout">
            <form:form action="${pageContext.request.contextPath}/register.htm" method="post" modelAttribute="customer"
                ...
                <div class="form-group has-success">
                    ...
                    <div class="col-xs-9">
                        <form:input path="billingAddress.district" class="form-control" placeholder="Enter District"
                ...
                <div class="form-group has-success">
                    ...
                    <div class="col-xs-9">
                        <form:input path="shippingAddress.district" class="form-control" placeholder="Enter District"
