    ...
    <div class="container">
	   ...
	   <div class="page-header title">
		...
		<div class="form-layout" >
	       ...
	       <form:form   action="${pageContext.request.contextPath}/register.htm"   method="post" modelAttribute="customer"     class="form-horizontal"  >
			    ...
			    <label class="col-xs-3 control-label" for="customerName"></label>
					<div class="col-xs-9">
				       <form:errors path="billingAddress.district" cssStyle="color: #ff0000" />		
					</div>
			    
			    </div>
				
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="billingAddress.district">District</label>
					<div class="col-xs-9">
						
					   <form:input path="billingAddress.district" class="form-control" placeholder="Enter District" id="billingAddress.district" />
					</div>
				</div>
			    ...
			    <label class="col-xs-3 control-label" for="customerName"></label>
					<div class="col-xs-9">
				       <form:errors path="shippingAddress.district" cssStyle="color: #ff0000" />		
					</div>
			    
			    </div>
				
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="shippingAddress.district">District:</label>
					<div class="col-xs-9">
						
					   <form:input path="shippingAddress.district" class="form-control" placeholder="Enter District" id="shippingAddress.district" />
					</div>
				</div>
